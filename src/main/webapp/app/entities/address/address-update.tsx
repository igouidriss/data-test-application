  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="dataTestApplicationApp.address.home.createOrEditLabel" data-cy="AddressCreateUpdateHeading">
            <Translate contentKey="dataTestApplicationApp.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('dataTestApplicationApp.address.numberStreet')}
                id="address-numberStreet"
                name="numberStreet"
                data-cy="numberStreet"
                type="text"
              />
              <ValidatedField
                label={translate('dataTestApplicationApp.address.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('dataTestApplicationApp.address.city')}
                id="address-city"
                name="city"
                data-cy="city"
                type="text"
