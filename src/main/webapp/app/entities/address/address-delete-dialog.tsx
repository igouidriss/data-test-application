...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataTestApplicationApp.address.delete.question">
        <Translate contentKey="dataTestApplicationApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
