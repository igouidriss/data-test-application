...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './casting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_CASTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CASTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CASTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CASTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CASTING actions', async () => {
      const expectedActions = [
        {
