...
export const SessionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataTestApplicationApp.session.delete.question">
        <Translate contentKey="dataTestApplicationApp.session.delete.question" interpolate={{ id: sessionEntity.id }}>
