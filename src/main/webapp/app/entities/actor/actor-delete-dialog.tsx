...
export const ActorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataTestApplicationApp.actor.delete.question">
        <Translate contentKey="dataTestApplicationApp.actor.delete.question" interpolate={{ id: actorEntity.id }}>
