  ...
  return (
    <div>
      <h2 id="actor-heading" data-cy="ActorHeading">
        <Translate contentKey="dataTestApplicationApp.actor.home.title">Actors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dataTestApplicationApp.actor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/actor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dataTestApplicationApp.actor.home.createLabel">Create new Actor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {actorList && actorList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dataTestApplicationApp.actor.id">ID</Translate>{' '}
            ...
            <tbody>
              {actorList.map((actor, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{actor.birthDate ? <TextFormat type="date" value={actor.birthDate} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/actor/${actor.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dataTestApplicationApp.actor.home.notFound">No Actors found</Translate>
            </div>
          )
        )}
      </div>
