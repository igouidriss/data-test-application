...
export const MovieDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dataTestApplicationApp.movie.delete.question">
        <Translate contentKey="dataTestApplicationApp.movie.delete.question" interpolate={{ id: movieEntity.id }}>
