...
class AddressResourceIT {
    ...
    private static final String DEFAULT_NUMBER_STREET = "AAAAAAAAAA";
    private static final String UPDATED_NUMBER_STREET = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().numberStreet(DEFAULT_NUMBER_STREET).postalCode(DEFAULT_POSTAL_CODE).city(DEFAULT_CITY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().numberStreet(UPDATED_NUMBER_STREET).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getNumberStreet()).isEqualTo(DEFAULT_NUMBER_STREET);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberStreet").value(hasItem(DEFAULT_NUMBER_STREET)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.numberStreet").value(DEFAULT_NUMBER_STREET))
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.numberStreet(UPDATED_NUMBER_STREET).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getNumberStreet()).isEqualTo(UPDATED_NUMBER_STREET);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.numberStreet(UPDATED_NUMBER_STREET).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
